...
public class UniversityStudentPrint {
public static int MAX_STUDENT_COUNT=300; //최대학생 300명
	...
	public static void main(String[] args) {
		...
		stdMng.insert(new UniversityStudent("홍길동",1,1,1,100,90,80));
	
		stdMng.print();
		System.out.println("------------------------------");
		
		stdMng.modify(new UniversityStudent("유관순",1,1,1,100,100,100));
		stdMng.print();
		System.out.println("------------------------------");
		
	
		stdMng.delete(new UniversityStudent("홍길동",1,1,1,0,0,0));
		stdMng.print();
